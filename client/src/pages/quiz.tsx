              ...
              {currentStep === 5 && (
                <QuizStep>
                  ...
                  <div className="text-center">
                    ...
                    <Button 
                      onClick={nextStep}
                      className="w-full bg-blue-600 bg-opacity-100 hover:bg-blue-700 text-white font-semibold py-3 px-4 whitespace-normal break-words text-sm md:text-base leading-tight"
                    >
                      ...
                      <div className="bg-gray-50 p-4 md:p-8 rounded-lg mb-6 md:mb-8">
                        ...
                        <div className="max-w-3xl mx-auto">
                          <div className="flex flex-col md:flex-row items-center justify-center mb-4">
                            <img 
                              src="/vargas-photo.jpg" 
                              alt="Vargas - Especialista em Finanças" 
                              className="w-12 h-12 md:w-16 md:h-16 rounded-full mb-2 md:mb-0 md:mr-4 object-cover border-2 border-gray-200"
                            />
